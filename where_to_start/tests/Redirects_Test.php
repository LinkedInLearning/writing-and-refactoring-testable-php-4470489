...
class Redirects_Test extends \PHPUnit\Framework\TestCase
{
    ...
    public function setUp(): void
    {
        ...
        require_once __DIR__ . '/../Redirect_Collection_Interface.php';
        require_once __DIR__ . '/../Redirect_Collection_From_Array.php';
        parent::setUp(); // TODO: Change the autogenerated stub
    }

    public function test_to_array(): void {
        $redirects = new \Redirects( new \Redirect_Collection_From_Array( [
